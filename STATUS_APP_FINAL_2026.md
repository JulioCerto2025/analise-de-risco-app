# ESTADO MESTRE: ANÁLISE DE RISCO SPDA NBR 5419-2 (2026)
...
- **NÃO** reintroduza o Painel ADM como um card flutuante no `App.tsx`. Ele deve permanecer dentro do `ProjectInfoStep.tsx`.
- Sempre priorize o `useMemo` com as dependências `isAdmin` e `showAdminPanel` para evitar erros de sincronismo.
