import{r as S,j as i,A as et,m as je}from"./motion-CZTIYVKD.js";import{P as tt,t as Ie,w as ve,K as at,v as ot,I as nt,R as it,J as st,M as lt,N as rt,O as ct,Q as mt,r as qe,E as pt,s as dt,G as ut,V as xt,C as Oe,a as Ve,b as We,B as Ae,e as Ue}from"./index-CRFntGln.js";import{F as He,X as ht,n as gt,L as $t,l as Pt,T as ft}from"./icons-ggQqh8om.js";import"./react-Bzgz95E1.js";import"./charts-D7Odik-1.js";function A(e,t){const a=e.find(P=>String(P.value)===String(t));return a?a.label:`Valor ${t}`}function Rt(e){var I,v,T,b,E,y,j,z,D,x,w,H,k,V,R,C,N,J,oe,Se,le,re,ce,me,pe,de,ue,xe,he,ge,$e,Pe,fe,Re,_e,Fe,r,_,F;const{calculations:t,probability_calculations:a,loss_calculations:P,risk_results:c,frequency_results:m,probability_data:o,zones:d,selected_risk_components:M}=e,s=((I=d[0])==null?void 0:I.loss_data)||{};let l="";l+=`### Etapa — Probabilidade (P)
...
* *Cálculo:* FZ = (${(Re=t.ni_electric)==null?void 0:Re.toExponential(3)} × ${(_e=a.PZ)==null?void 0:_e.toExponential(3)}) + (${(Fe=t.ni_data)==null?void 0:Fe.toExponential(3)} × ${(r=a.PZT)==null?void 0:r.toExponential(3)})
...
`,l}async function _t(e){var le,re,ce,me,pe,de,ue,xe,he,ge,$e,Pe,fe,Re,_e,Fe;const{calculations:t,risk_results:a,frequency_results:P}=e,c={dados:1,parametros:2,calculos:3,resultados:4,parecer:5},m=Rt(e),o=r=>{var ee,Y;const _=Object.entries(r.risks_to_analyze).filter(([,u])=>u).map(([u])=>u),F={R1:1e-5,R3:.001,R4:.001},h=[];_.forEach(u=>{const q=r.risk_results[u]||0,O=F[u];q>O&&h.push(u)});const n=r.frequency_config.is_critical_system?.1:1,W=(((ee=r.frequency_results)==null?void 0:ee.F)||0)>n,U=["RA","RB","RC","RM","RU","RV","RW","RZ"].map(u=>({k:u,v:r.risk_results[u]||0})).sort((u,q)=>q.v-u.v).slice(0,2).map(u=>{var q;return`${String(u.k)} (${(q=u.v)==null?void 0:q.toExponential(2)})`}).join(", "),Z=`Este parecer foi elaborado com base na NBR 5419, considerando os riscos selecionados (${_.join(", ")||"nenhum"}) e a frequência de danos aos sistemas.`,be=`Frequência de Danos (F): **${(((Y=r.frequency_results)==null?void 0:Y.F)||0).toExponential(3)}**; Limite (FT): **${n.toFixed(1)}** → ${W?"**NÃO ACEITÁVEL**":"**ACEITÁVEL**"}.`,G=_.length?`Riscos totais: ${_.map(u=>`**${u}=${(r.risk_results[u]||0).toExponential(3)}** (RT=${F[u].toExponential(1)})`).join("; ")}.`:"Nenhum risco foi selecionado para análise próxima.",K=`Componentes dominantes observados: ${U}.`,ie=`Recomendações prioritárias:
...
`)},d=Object.entries(e.risks_to_analyze).filter(([,r])=>r).map(([r],_)=>{var G,K,ie,X,ee,Y,u,q,O;const F=a[r]||0,h={R1:1e-5,R3:.001,R4:.001}[r]||0,n=F<=h,W={R1:"Perda de Vidas Humanas",R3:"Perda de Patrimônio Cultural",R4:"Perda de Valor Econômico"}[r],ne=n?"🟢 ✅":"🔴 ❌",f=e.selected_risk_components;let U="",Z="";if(r==="R1"){const g=[],p=[];f.RA&&(g.push("RA"),p.push(`${(G=a.RA)==null?void 0:G.toExponential(3)}`)),f.RB&&(g.push("RB"),p.push(`${(K=a.RB)==null?void 0:K.toExponential(3)}`)),f.RC&&(g.push("RC"),p.push(`${(ie=a.RC)==null?void 0:ie.toExponential(3)}`)),f.RM&&(g.push("RM"),p.push(`${(X=a.RM)==null?void 0:X.toExponential(3)}`)),f.RU&&(g.push("RU"),p.push(`${((a.RU||0)+(a.RUT||0)).toExponential(3)}`)),f.RV&&(g.push("RV"),p.push(`${((a.RV||0)+(a.RVT||0)).toExponential(3)}`)),f.RW&&(g.push("RW"),p.push(`${((a.RW||0)+(a.RWT||0)).toExponential(3)}`)),f.RZ&&(g.push("RZ"),p.push(`${((a.RZ||0)+(a.RZT||0)).toExponential(3)}`)),U=g.join(" + "),Z=`${p.join(" + ")} = ${F.toExponential(3)}`}else if(r==="R3"){const g=[],p=[];f.RB&&(g.push("RB3"),p.push(`${(ee=a.RB3)==null?void 0:ee.toExponential(3)}`)),f.RV&&(g.push("RV3"),p.push(`${((a.RV3||0)+(a.RVT3||0)).toExponential(3)}`)),U=g.join(" + "),Z=`${p.join(" + ")} = ${F.toExponential(3)}`}else if(r==="R4"){const g=[],p=[];f.RA&&(g.push("RA4"),p.push(`${(Y=a.RA4)==null?void 0:Y.toExponential(3)}`)),f.RB&&(g.push("RB4"),p.push(`${(u=a.RB4)==null?void 0:u.toExponential(3)}`)),f.RC&&(g.push("RC4"),p.push(`${(q=a.RC4)==null?void 0:q.toExponential(3)}`)),f.RM&&(g.push("RM4"),p.push(`${(O=a.RM4)==null?void 0:O.toExponential(3)}`)),f.RU&&(g.push("RU4"),p.push(`${((a.RU4||0)+(a.RUT4||0)).toExponential(3)}`)),f.RV&&(g.push("RV4"),p.push(`${((a.RV4||0)+(a.RVT4||0)).toExponential(3)}`)),f.RW&&(g.push("RW4"),p.push(`${((a.RW4||0)+(a.RWT4||0)).toExponential(3)}`)),f.RZ&&(g.push("RZ4"),p.push(`${((a.RZ4||0)+(a.RZT4||0)).toExponential(3)}`)),U=g.join(" + "),Z=`${p.join(" + ")} = ${F.toExponential(3)}`}const be=U?`
* *Composição (${r}):* ${U}
* *Cálculo:* ${Z}`:"";return`### ${c.resultados}.${_+1}. Risco ${r} - ${W}
* **Risco Total Calculado (${r}):** **${F.toExponential(3)}**
* **Risco Tolerável (RT):** **${h.toExponential(1)}**
* **Resultado:** ${ne} O risco ${r} é **${n?"ACEITÁVEL":"NÃO ACEITÁVEL"}**.${be}`}).join(`

`),M=e.frequency_config.is_critical_system?.1:1,s=(P.F||0)<=M,l=s?"🟢 ✅":"🔴 ❌",L=r=>{try{return btoa(unescape(encodeURIComponent(r)))}catch{return""}},B=(r,_,F=720,h=300,n)=>{const ne=n!=null&&n.showLegend?72:48,f=44,U=8,Z=_.length,be=F-80,G=h-ne-f,K=Math.max(10,Math.floor((be-(Z-1)*U)/Z)),ie=typeof(n==null?void 0:n.toleranceLine)=="number"?Math.max(n.toleranceLine,0):0,X=$=>Math.log10(Math.max($,1e-12)),ee=[..._.map($=>$.value),ie].filter($=>$>0),Y=Math.max(...ee.map($=>X($))),u=Math.min(..._.map($=>X($.value))),q=(n==null?void 0:n.barColor)||"#60A5FA",O=n==null?void 0:n.barColors,g=(n==null?void 0:n.bg)||"#FFFFFF",p="#111827",Ge="#475569",ze=typeof(n==null?void 0:n.labelAngle)=="number"?n.labelAngle:-35,Ke="";let Me="";_.forEach(($,se)=>{const te=40+se*(K+U),Ce=(X($.value)-u)/Math.max(Y-u,1e-6),ae=Math.max(2,Math.floor(Ce*G)),Q=ne+(G-ae),Ee=$.value.toExponential(2),Te=O?O[se%O.length]:q,ye=h-f+18,Be=te+K/2,Le=$.name==="R Total"||$.name==="F Total",Je=0,Ye=Le?12:10,Qe=Le?"700":"400";Me+=`
  ...
  <line x1="40" y1="${ae}" x2="${F-40}" y2="${ae}" stroke="#ef4444" stroke-width="2" stroke-dasharray="3 3" />`}let Ne="";if(!!(n!=null&&n.showLegend)&&O&&_.length){const $=typeof(n==null?void 0:n.legendBoxSize)=="number"?Math.max(6,n.legendBoxSize):10,se=typeof(n==null?void 0:n.legendColGap)=="number"?Math.max(2,n.legendColGap):8,te=typeof(n==null?void 0:n.legendRowGap)=="number"?Math.max(2,n.legendRowGap):8,Ce=typeof(n==null?void 0:n.legendFontSize)=="number"?Math.max(8,n.legendFontSize):11,ae=Math.min(F-40,Math.max(120,(n==null?void 0:n.legendMaxWidth)||F-40));let Q=40,Ee=46;_.forEach((Te,ye)=>{const Be=O[ye%O.length],Le=Math.min(160,Math.max(40,Te.name.length*7));Q+$+4+Le>ae&&(Q=40,Ee+=$+te),Ne+=`
...
<svg xmlns="http://www.w3.org/2000/svg" width="${F}" height="${h}" viewBox="0 0 ${F} ${h}">
  ...
  ${ke}
  ${Me}
</svg>`;return`data:image/svg+xml;base64,${L(Xe)}`},v=["RA","RB","RC","RM","RU","RV","RW","RZ"].map(r=>({name:r,value:e.risk_results[r]||1e-12,active:!!e.selected_risk_components[r]})),T=e.risks_to_analyze.R1?"R1":e.risks_to_analyze.R3?"R3":e.risks_to_analyze.R4?"R4":"R1",b=e.risk_results[T]||0,E=[...v.map(r=>({name:r.name,value:r.value})),{name:"R Total",value:b}],y=Object.entries(e.frequency_results||{}).filter(([r])=>r!=="F").map(([r,_])=>({name:r,value:_||0})),j=["#60A5FA","#A78BFA","#F472B6","#FB7185","#F59E0B","#34D399","#22D3EE","#93C5FD"],z="#CBD5E1",D=e.risks_to_analyze.R1?1e-5:e.risks_to_analyze.R3||e.risks_to_analyze.R4?.001:1e-5,w=b<=D?"#10B981":"#EF4444",H=E.map((r,_)=>{var h;return r.name==="R Total"?w:((h=v[_])==null?void 0:h.active)?j[_%j.length]:z}),k=["#F87171","#60A5FA","#A78BFA","#34D399","#F59E0B","#FB7185","#64748B"],V=B("Componentes de Risco — Global",E,720,300,{barColors:H,labelAngle:-30,legendMaxWidth:420,toleranceLine:D}),R=[...y,{name:"F Total",value:((le=e.frequency_results)==null?void 0:le.F)||0}],C=(((re=e.frequency_results)==null?void 0:re.F)||0)<=M,N="#CBD5E1",J=R.map((r,_)=>{if(r.name==="F Total")return C?"#10B981":"#EF4444";const F=k[_%k.length];return(r.value||0)>0?F:N}),oe=B("Frequência de Danos — Global",R,720,280,{barColors:J,labelAngle:-40,legendFontSize:10,legendMaxWidth:500,toleranceLine:M});return`
...
* **Frequência Calculada (F):** **${(Fe=P.F)==null?void 0:Fe.toExponential(3)}** danos/ano
...
`,m=!1);const B=o+1<P.length?P[o+1].trim():"",I=o-1>=0?P[o-1].trim():"",v=/^(Figura|FIGURA)\s*([0-9]+(?:\.[0-9]+)*)[\.:\-]\s*(.*)$/;let T=null;const b=B.match(v),E=I.match(v);b?(T=`Figura ${b[2]} — ${b[3]}`.trim(),o+=1):E?T=`Figura ${E[2]} — ${E[3]}`.trim():l&&l.trim().length>0&&(T=l.trim());const y=T?`<figcaption>${M(T)}</figcaption>`:"";c+=`<figure style="margin:${t.figureMarginTopPx}px 0 ${t.figureMarginBottomPx}px"><img src="${De(L)}" alt="${De(l)}" style="max-width:100%;height:auto;border-radius:4px;border:none;display:inline-block;page-break-inside:avoid"/>${y}</figure>
...
`,m=!0);let l=d.trim().substring(2);for(;o+1<P.length&&P[o+1].startsWith("  ");)l+=" "+P[o+1].trim(),o++;const L=l.replace(/\*/g,"").normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase(),B=/\bresultado:\b/.test(L),I=/\bcalculo:\b/.test(L),v=/\bformula:\b/.test(L),T=/^\*\*[^*]+?\*\*:/.test(l.trim()),b=T?t.blockMarginBetweenItemsPx:Math.max(0,t.listItemMarginTopPx),E=T||B||I||v?t.blockMarginBetweenItemsPx:t.listItemMarginBottomPx,y=`${b}px 0 ${E}px`,j=/(F[óo]rmula:|C[áa]lculo:|Resultado:)/gi,z="§§",x=l.replace(j,z+"$1").split(z).filter(w=>w.trim().length>0);if(x.length>1||/:\s*$/.test(l.trim())){let w="";for(const H of x){const k=H.replace(/\*/g,"").normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase(),V=/\bresultado:\b/.test(k),R=/\bcalculo:\b/.test(k),C=/\bformula:\b/.test(k),N=V||R||C?`${t.paragraphMarginTopPx}px 0 ${t.listItemExtraMarginBottomPx}px`:`${t.paragraphMarginTopPx}px 0 ${t.paragraphMarginBottomPx}px`;w+=`<p style="margin:${N};font-size:${t.paragraphFontSizePt}pt;line-height:${t.paragraphLineHeight}">${M(H)}</p>`,V&&(w+=`<p style="margin:0;height:${t.emptyLineHeightPx}px;line-height:0">&nbsp;</p>`)}c+=`<li style="margin:${y};font-size:${t.paragraphFontSizePt}pt;line-height:${t.paragraphLineHeight}">${w}</li>
`}else c+=`<li style="margin:${y};font-size:${t.paragraphFontSizePt}pt;line-height:${t.paragraphLineHeight}">${M(l)}</li>
`;continue}if(m&&(c+=`</ul>
`,m=!1),d.trim()){const l=o+1<P.length?P[o+1].trim():"";if(!(/^(Figura|FIGURA)\s*([0-9]+(?:\.[0-9]+)*)[\.:\-]\s*(.*)$/.test(d.trim())&&/^!\[(.*?)\]\((.*?)\)$/.test(l))){const B=/(F[óo]rmula:|C[áa]lculo:|Resultado:)/gi,T=d.replace(B,"§§$1").split("§§").filter(b=>b.trim().length>0);if(T.length>1)for(const b of T){const E=b.replace(/\*/g,"").normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase(),y=/\bresultado:\b/.test(E),j=/\bcalculo:\b/.test(E),z=/\bformula:\b/.test(E),D=y||j||z?`${t.paragraphMarginTopPx}px 0 ${t.listItemExtraMarginBottomPx}px`:`${t.paragraphMarginTopPx}px 0 ${t.paragraphMarginBottomPx}px`;c+=`<p style="margin:${D};font-size:${t.paragraphFontSizePt}pt;line-height:${t.paragraphLineHeight}">${M(b)}</p>
`,y&&(c+=`<p style="margin:0;height:${t.emptyLineHeightPx}px;line-height:0">&nbsp;</p>
`)}else{const b=d.replace(/\*/g,"").normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase(),E=/\bresultado:\b/.test(b),y=/\bcalculo:\b/.test(b),j=/\bformula:\b/.test(b),z=E||y||j?`${t.paragraphMarginTopPx}px 0 ${t.listItemExtraMarginBottomPx}px`:`${t.paragraphMarginTopPx}px 0 ${t.paragraphMarginBottomPx}px`;c+=`<p style="margin:${z};font-size:${t.paragraphFontSizePt}pt;line-height:${t.paragraphLineHeight}">${M(d)}</p>
